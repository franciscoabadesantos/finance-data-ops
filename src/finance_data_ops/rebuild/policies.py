...
_POLICIES: dict[DomainName, DomainPolicy] = {
    "market": DomainPolicy(
        ...
        wipe_tables=("source_cache.market_price_daily",),
    ...
    "fundamentals": DomainPolicy(
        ...
        sleep_seconds=0.1,
        preflight_probe_table="source_cache.fundamentals",
        inter_batch_health_check_every_n_batches=5,
        max_consecutive_db_failures=3,
        max_consecutive_chunk_failures=1,
        max_latency_ms=2500,
        refresh_materialized_views=(),
        rebuild_status_assets=("source_cache.fundamentals",),
        rebuild_coverage=True,
        wipe_tables=("source_cache.fundamentals",),
        allow_region_scope=True,
        allow_ticker_scope=True,
    ...
    "earnings": DomainPolicy(
        ...
        chunk_granularity="ticker",
        sleep_seconds=0.1,
        preflight_probe_table="source_cache.earnings",
        inter_batch_health_check_every_n_batches=5,
        max_consecutive_db_failures=3,
        max_consecutive_chunk_failures=1,
        max_latency_ms=2500,
        refresh_materialized_views=(),
        rebuild_status_assets=("source_cache.earnings",),
        rebuild_coverage=True,
        wipe_tables=("source_cache.earnings",),
        allow_region_scope=True,
        allow_ticker_scope=True,
        default_window_days=365,
        full_rebuild_start_date=None,
