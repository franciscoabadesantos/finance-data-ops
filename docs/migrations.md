...
- `market_quotes` (`ticker,name,price,change,change_percent,market_cap_text,source,fetched_at,created_at,updated_at`)
- `market_quotes_history` (`ticker,fetched_at,price,change,change_percent,market_cap,source`)
