#!/usr/bin/env python3
"""Scheduler-friendly script wrapper for Data Ops ticker validation flow."""
...
from flows.prefect_dataops_daily import dataops_ticker_validation_flow


def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run ticker validation flow locally.")
    parser.add_argument("input_symbol", type=str, help="Raw symbol input to validate (for example: ANZ).")
