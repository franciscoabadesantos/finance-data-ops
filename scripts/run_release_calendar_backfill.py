#!/usr/bin/env python3
"""Historical economic release-calendar backfill runner (idempotent)."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run idempotent historical release-calendar backfill.")
    ...
    parser.add_argument("--sleep-seconds", type=float, default=0.0, help="Optional provider pacing.")
